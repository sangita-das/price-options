import { Bar, BarChart, CartesianGrid, LineChart as LChart, Line, Tooltip, XAxis, YAxis } from 'recharts';
...
<div>
            ...
            <div>
             ...
             <BarChart width={600} height={300} data={subjectMarksData}>
    <XAxis dataKey="chemistry" stroke="green" />
    <YAxis />
        <Tooltip />
    <CartesianGrid stroke="blue" strokeDasharray="5 5" />
    <Bar dataKey="physics" fill="#8884d8" barSize={30} />
  </BarChart>
